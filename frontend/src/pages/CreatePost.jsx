    ...
    <div className="max-w-4xl mx-auto my-8 relative">
      ...
      <div className="relative p-8 bg-white dark:bg-gray-800 rounded-xl shadow-xl border-2 border-blue-100 dark:border-gray-700 transform -rotate-1">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-blue-800 dark:text-blue-300 mb-2">Tech Blog</h1>
          <p className="text-gray-600 dark:text-gray-400 italic">Partagez vos connaissances informatiques</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          <div className="bg-slate-50/50 dark:bg-gray-700/30 p-6 rounded-lg border border-blue-100 dark:border-gray-600">
            <label htmlFor="title" className="block text-lg font-medium text-blue-800 dark:text-blue-300 mb-2">
          ...
          <div className="bg-slate-50/50 dark:bg-gray-700/30 p-6 rounded-lg border border-blue-100 dark:border-gray-600">
            <label htmlFor="content" className="block text-lg font-medium text-blue-800 dark:text-blue-300 mb-2">
          ...
          <div className="bg-slate-50/50 dark:bg-gray-700/30 p-6 rounded-lg border border-blue-100 dark:border-gray-600">
            <label htmlFor="tags" className="block text-lg font-medium text-blue-800 dark:text-blue-300 mb-2">
              Tags techniques
            </label>
